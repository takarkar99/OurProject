  ...
  <div className="container-fluid">
    ...
    <div className="collapse navbar-collapse" id="navbarNav">
      <ul className="navbar-nav">
        ...
        <li className="nav-item">
          <NavLink className="nav-link" to="/adddefualter">Add Customer to Defualter</NavLink>
        </li>
        <li className="nav-item">
          <NavLink className="nav-link" to="/checkdocument">Check Document</NavLink>
        </li>
        <li>
          <NavLink className="nav-link" to="/defualtershow">Show Defualter Customer</NavLink>
        </li>&nbsp;&nbsp;&nbsp;&nbsp;
        <li>
          <span style={{color:'red'}}>Operational_Head {email}</span>
