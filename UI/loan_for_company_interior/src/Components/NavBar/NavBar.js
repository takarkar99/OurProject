  ...
  <div className="container-fluid">
    ...
    <div className="collapse navbar-collapse" id="navbarNav">
      <ul className="navbar-nav">
        ...
        <li className="nav-item">
          <NavLink className="nav-link" to="/documentshow">Show Document</NavLink>
        </li>
        <li className="nav-item">
          <NavLink className="nav-link" to="/guarantorshow">Show Guarantor</NavLink>
        </li>
        <li className="nav-item">
          <NavLink className="nav-link" to="/loanshow">Show Loans</NavLink>
        </li>
        <li className="nav-item">
          <NavLink className="nav-link" to="/vendorshow">Show Vendor</NavLink>
        </li>
        <li className="nav-item">
          <NavLink className="nav-link" to="/registereduser">Registered Users</NavLink>
        </li>
        <li className="nav-item">
