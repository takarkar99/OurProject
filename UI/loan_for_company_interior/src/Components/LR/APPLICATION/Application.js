...
function Application() {
    ...
    const onFormSubmit = (data) => {
        console.log(data)
        axios.post('http://localhost:8000/application/applicationcreate/', data);
  ...
  return (
    ...
    <div className='container'>
        <center><h1><u>APPLICATION FORM</u></h1></center>
        <form method='post' onSubmit={handleSubmit(onFormSubmit)}>
            <label htmlFor='uid'><b>USER ID:</b></label>
            <input type='number' id='uid' name='user' value={userId}
